...
export const metadata: Metadata = {
  title: 'Kargo ve Teslimat | voltekno',
  description: 'voltekno kargo, teslimat ve paketleme süreçleri hakkında bilgiler.',
}
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-xs font-medium text-slate-500 mb-2" aria-label="Breadcrumb">
            ...
            <span className="text-slate-900 font-semibold">Kargo ve Teslimat</span>
          </nav>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 uppercase tracking-tight">Kargo ve Teslimat</h1>
          <p className="mt-1 text-sm text-slate-600">Siparişiniz güvenle ve hızlıca kapınıza gelsin</p>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">Teslimat Süreleri</h2>
            </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">Ücretsiz Kargo</h2>
            </div>
            <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">Sipariş Takibi</h2>
            </div>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">Teslimat Adresi</h2>
            </div>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div className="text-center pt-4">
            <Link href="/contact" className="text-brand hover:text-brand-hover font-medium">
