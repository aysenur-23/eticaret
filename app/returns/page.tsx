...
export const metadata: Metadata = {
  title: 'İade ve Değişim | voltekno',
  description: 'voltekno iade ve değişim politikası, süreçleri ve şartları hakkında bilgiler.',
}
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-xs font-medium text-slate-500 mb-2" aria-label="Breadcrumb">
            ...
            <span className="text-slate-900 font-semibold">İade ve Değişim</span>
          </nav>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 uppercase tracking-tight">İade ve Değişim</h1>
          <p className="mt-1 text-sm text-slate-600">Cayma hakkı ve iade koşullarımız</p>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">Cayma Hakkı</h2>
            </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">İade Süreci</h2>
            </div>
            <ol className="list-decimal list-inside text-slate-600 space-y-2 leading-relaxed">
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900">Garanti ve Arıza</h2>
            </div>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 md:p-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              İade veya değişim talebiniz için <Link href="/contact" className="text-brand hover:text-brand-hover font-medium">İletişim</Link> sayfamızdan bize ulaşabilir veya doğrudan e-posta gönderebilirsiniz. Sipariş numaranızı ve talebinizi (iade/değişim) belirtmeniz işlem süresini kısaltır.
            </p>
            <p className="text-slate-600 leading-relaxed">
              Detaylı hak ve yükümlülükler için <Link href="/terms" className="text-brand hover:text-brand-hover font-medium">Uzaktan Satış Sözleşmesi</Link> ve <Link href="/privacy" className="text-brand hover:text-brand-hover font-medium">Gizlilik</Link> sayfalarımıza bakabilirsiniz.
            </p>
          </div>
        </div>
      </div>
